...
static void *
ngx_curl_example_create_conf(ngx_cycle_t *cycle)
{
...
static char *
ngx_curl_example_init_conf(ngx_cycle_t *cycle, void *conf)
{
...
static char *
ngx_curl_example_enable(ngx_conf_t *cf, void *post, void *data)
{
    ngx_flag_t  *fp = data;
